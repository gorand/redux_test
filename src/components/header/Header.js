...
export default class Header extends Component {
  ...
  render() {
    ...
    const isEntrysPage = pathname.indexOf('entrys') > -1;
          ...
          <div className="container-fluid">
            ...
            <div id="collapsingNavbar" className="collapse navbar-toggleable-xs">
              ...
              <ul className="nav navbar-nav">
                ...
                <li title="List Entrys" className={isEntrysPage ? 'nav-item active' : 'nav-item'}><Link className="nav-link" to="/entrys">List Entrys</Link></li>
              </ul>
